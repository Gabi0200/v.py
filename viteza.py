...
try:
    ...
    try:
        ...
        raise SystemExit('[+]\033[1;31mYour python installation is missing required HTTP '
                         '[+]\033[1;31mclient classes:\n\n'
                         '[+]\033[1;31mPython 2: %s\n'
                         '[+]\033[1;31mPython 3: %s' % (e_http_py2[1], e_http_py3[1]))
...
def speedtest():
    ...
    if not args.simple:
        print_('     \033[1;31m...::::\033[1;33mA?¦?¦?[#Fluffy] \033[1;32mSPEED TESTER VPS \033[1;33mA?¦?¦?\033[1;31m::::...')
    try:
        config = getConfig()
    except URLError:
    ...
    if not args.simple:
        print_('[+]\033[1;31mRetrieving configuration speedtest.net \033[1;31mand server list\033[1;m A?L?¦?¦')
    ...
    if not args.simple:
        print_('[+]\033[1;31mTesting from\033[1;m \033[1;33m%(isp)s\033[1;m (\033[1;31mx.x.x.x\033[1;m)\033[1;31m A?L?¦?¦' % config['client'])
    ...
    if args.server:
        ...
        if not args.simple:
            print_('[+]\033[1;31mSelecting best server based on latency\033[1;m A?L?¦?¦')
        best = getBestServer(servers)

    if not args.simple:
        print_(('[+]\033[1;31mHosted by \033[1;33m%(sponsor)s\033[1;m (\033[1;33m%(name)s\033[1;m) [\033[1;31m%(d)0.2f km]\033[1;31m:\033[1;33m '
    ...
    if not args.simple:
        print_('[+]\033[1;31mTesting download speed >', end='')
    dlspeed = downloadSpeed(urls, args.simple)
    if not args.simple:
        print_()
    print_('[+]\033[1;31mDownload: \033[1;33m%0.2f M%s/s' %
    ...
    for size in sizesizes:
        for i in range(0, 25):
            sizes.append(size)
    if not args.simple:
        print_('[+]\033[1;31mTesting upload speed >', end='')
    ulspeed = uploadSpeed(best['url'], sizes, args.simple)
    if not args.simple:
        print_()
    print_('[+]\033[1;31mUpload: \033[1;33m%0.2f M%s/s\033[1;m' %
